...
let btn_next    = document.querySelector('#nouveau');
...
btn_next.addEventListener('click', () => {
    do {
        dernier     = id_random;
        id_random   = genererNombreEntier(citations.length);
    } while (id_random == dernier);

    citation.textContent    = citations[id_random][0];
    auteur.textContent      = citations[id_random][1];   
